...
/* Private defines -----------------------------------------------------------*/
#define TFT_N_Pin GPIO_PIN_0
#define TFT_N_GPIO_Port GPIOC
#define TFT_P_Pin GPIO_PIN_1
#define TFT_P_GPIO_Port GPIOC
#define I_OUT_Pin GPIO_PIN_2
#define I_OUT_GPIO_Port GPIOC
#define V_OUT_Pin GPIO_PIN_3
#define V_OUT_GPIO_Port GPIOC
...
#define BUSY_TFT_Pin GPIO_PIN_6
#define BUSY_TFT_GPIO_Port GPIOA
